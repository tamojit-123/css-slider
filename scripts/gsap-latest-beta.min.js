...
!function (t, e) {
    ...
    Qt.version = qt.version = oe.version = "3.8.0", l = 1, u() && Dt();
    ...
    var nr, ar, sr, or = {
        name: "css", register: rd, targetTest: function targetTest(t) {
            ...
            var a, s, u, h, l, f, d, c, p, _, m, g, v, y, b, T = this._props, w = t.style, x = r.vars.startAt;
            for (d in fe || rd(), e) if ("autoRound" !== d && (s = e[d], !ft[d] || !Sb(d, e, r, i, t, n))) if (l = typeof s, f = Qe[d], "function" === l && (l = typeof (s = s.call(r, i, t, n))), "string" === l && ~s.indexOf("random(") && (s = fb(s)), f) f(this, t, d, s, r) && (b = 1); else if ("--" === d.substr(0, 2)) a = (getComputedStyle(t).getPropertyValue(d) + "").trim(), s += "", At.lastIndex = 0, At.test(a) || (c = Pa(a), p = Pa(s)), p ? c !== p && (a = zd(t, d, a, p) + p) : c && (s += c), this.add(w, "setProperty", a, s, i, n, 0, 0, d), T.push(d); else if ("undefined" !== l) {
                if (x && d in x ? (a = "function" == typeof x[d] ? x[d].call(r, i, t, n) : x[d], d in Y.units && !Pa(a) && (a += Y.units[d]), o(a) && ~a.indexOf("random(") && (a = fb(a)), "=" === (a + "").charAt(1) && (a = Ad(t, d))) : a = Ad(t, d), h = parseFloat(a), (_ = "string" === l && "=" === s.charAt(1) ? +(s.charAt(0) + "1") : 0) && (s = s.substr(2)), u = parseFloat(s), d in qe && ("autoAlpha" === d && (1 === h && "hidden" === Ad(t, "visibility") && u && (h = 0), xd(this, w, "visibility", h ? "inherit" : "hidden", u ? "inherit" : "hidden", !u)), "scale" !== d && "transform" !== d && ~(d = qe[d]).indexOf(",") && (d = d.split(",")[0])), m = d in Ie) if (g || ((v = t._gsap).renderTransform && !e.parseTransform || $e(t, e.parseTransform), y = !1 !== e.smoothOrigin && v.smooth, (g = this._pt = new ae(this._pt, w, Ye, 0, 1, v.renderTransform, v, 0, -1)).dep = 1), "scale" === d) this._pt = new ae(this._pt, v, "scaleY", v.scaleY, (_ ? _ * u : u - v.scaleY) || 0), T.push("scaleY", d), d += "X"; else {
                    if ("transformOrigin" === d) {
                        s = Dd(s), v.svg ? Ld(t, s, 0, y, 0, this) : ((p = parseFloat(s.split(" ")[2]) || 0) !== v.zOrigin && xd(this, v, "zOrigin", v.zOrigin, p), xd(this, w, d, Je(a), Je(s)));
                        continue
                    }
                    if ("svgOrigin" === d) {
                        Ld(t, s, 1, y, 0, this);
                ...
                } else d in w || (d = Ve(d) || d);
                if (m || (u || 0 === u) && (h || 0 === h) && !Ne.test(s) && d in w) u = u || 0, (c = (a + "").substr((h + "").length)) !== (p = Pa(s) || (d in Y.units ? Y.units[d] : c)) && (h = zd(t, d, a, p)), this._pt = new ae(this._pt, m ? v : w, d, h, _ ? _ * u : u - h, m || "px" !== p && "zIndex" !== d || !1 === e.autoRound ? $c : bd), this._pt.u = p || 0, c !== p && (this._pt.b = a, this._pt.r = ad); else if (d in w) Bd.call(this, t, d, a, s); else {
                    if (!(d in t)) {
                        N(d, s);
                        continue
                    }
